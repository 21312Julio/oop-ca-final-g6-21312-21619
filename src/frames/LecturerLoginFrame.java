...
public class LecturerLoginFrame extends javax.swing.JFrame {
    ...
    // Check if lecturer exists in database before logging in 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerLoginFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LecturerLoginFrame().setVisible(true);
            }
        });
    }
